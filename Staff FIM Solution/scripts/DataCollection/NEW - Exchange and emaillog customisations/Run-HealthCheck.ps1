...
Import-Module -Name $ScriptDir\Unify.Health_Custom.psm1 -ErrorAction stop
...
# BEGIN Comment out the forced upload to OMS -- Adrian 5/9/17
if ($false)
{
...
# END Comment out the forced upload to OMS -- Adrian 5/9/17
}

#---------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/SearchScopeConfiguration[not(starts-with(DisplayName,'AAA')) and not(contains(DisplayName,'NAB')) and not(contains(DisplayName,'CLINK')) and not(contains(DisplayName,'DEEWR'))]") -MessageSize 99999999 -AllLocales

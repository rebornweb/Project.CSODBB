...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/BatchJob","/BatchJob/batchTargetMPR","/ManagementPolicyRule[contains(DisplayName,'batch')]","/Set[contains(DisplayName,'batch')]","/SearchScopeConfiguration[contains(DisplayName,'batch')]") -MessageSize 99999999 -AllLocales

...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and ActionWorkflowDefinition=/WorkflowDefinition[contains(DisplayName,'Event Broker') or contains(DisplayName,'Auto Pilot')]]") -MessageSize 99999999 -AllLocales

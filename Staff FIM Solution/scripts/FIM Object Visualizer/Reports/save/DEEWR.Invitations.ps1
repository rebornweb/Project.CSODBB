...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/WorkflowDefinition[not(starts-with(DisplayName,'AAA')) and contains(DisplayName,'Invit')]","/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and contains(DisplayName,'Invit')]") -MessageSize 99999999 -AllLocales

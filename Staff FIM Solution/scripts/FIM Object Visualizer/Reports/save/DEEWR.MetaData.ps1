...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig (`
    "/Set[not(starts-with(DisplayName,'AAA')) and (contains(DisplayName,'meta') or contains(DisplayName,'skill'))]",`
    "/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and (contains(DisplayName,'meta') or contains(DisplayName,'skill'))]") -MessageSize 99999999 -AllLocales

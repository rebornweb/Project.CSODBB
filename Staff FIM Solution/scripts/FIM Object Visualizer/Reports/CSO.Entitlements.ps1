...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/WorkflowDefinition[not(starts-with(DisplayName,'AAA')) and not(starts-with(DisplayName,'CLINK')) and contains(DisplayName,'Entitlement')]","/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and not(starts-with(DisplayName,'CLINK')) and contains(DisplayName,'Entitlement')]") -MessageSize 99999999 -AllLocales

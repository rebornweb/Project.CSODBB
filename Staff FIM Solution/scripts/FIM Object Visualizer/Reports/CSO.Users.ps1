...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/WorkflowDefinition[not(starts-with(DisplayName,'AAA')) and (contains(DisplayName,'User') or contains(DisplayName,'people') or contains(DisplayName,'staff') or contains(DisplayName,'student'))]","/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and (contains(DisplayName,'User') or contains(DisplayName,'people') or contains(DisplayName,'staff') or contains(DisplayName,'student'))]") -MessageSize 99999999 -AllLocales

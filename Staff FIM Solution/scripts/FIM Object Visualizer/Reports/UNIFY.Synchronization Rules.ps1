#---------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/SynchronizationRule[not(starts-with(DisplayName,'AAA'))]") -MessageSize 99999999 -AllLocales

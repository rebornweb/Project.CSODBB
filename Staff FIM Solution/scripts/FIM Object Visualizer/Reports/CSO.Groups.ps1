...
#----------------------------------------------------------------------------------------------------------
 ...
 $data = export-fimconfig -uri http://localhost:5725/resourcemanagementservice -customconfig ("/WorkflowDefinition[not(starts-with(DisplayName,'AAA')) and not(starts-with(DisplayName,'NAB')) and not(starts-with(DisplayName,'CLINK')) and contains(DisplayName,'Group')]","/ManagementPolicyRule[not(starts-with(DisplayName,'AAA')) and not(starts-with(DisplayName,'CLINK')) and not(starts-with(DisplayName,'NAB')) and contains(DisplayName,'Group')]") -MessageSize 99999999 -AllLocales

...
-->
    ...
    <HTML>
      <HEAD>
        <TITLE>
          MAConfigurationViewer 1.0 - <xsl:value-of select="//summary/heading"/>
        </TITLE>
        <STYLE type="text/css">
...
-->
              ...
              <TABLE class="tableMenu">
                <Tr class="trMenu">
                  ...
                  <xsl:if test="$category='AVP' or $category='Delimited' or $category='DSML' or $category='Fixed' or $category='LDIF'">
                    <Td class="tdMenu">
                      <b>
                        <A   href='#Attri' > Selected Attributes </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='AVP' or $category='Delimited' or $category='DSML' or $category='Fixed' or $category='LDIF'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#DefineObjectTypes' > Define Object Types </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='AD' or $category='AD GAL'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#AdForest' > AD Forest Connection Information </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='MSSQL' or $category='Oracle' or $category='DB2'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#DBConf' > Database Configuration </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#ColsConf' > Columns Configured </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test = "$category = 'AD' or $category = 'AD GAL'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#Part1' > Partition Information </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test = "$category = 'AD GAL'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#ADGAL1' > GAL Configuration </A>
                      </b>
                    </Td>
                  </xsl:if>

                  <xsl:if test="$category='Extensible' or $category = 'Extensible2'">
                    <Td class="tdMenu">
                      <b>
                        <A href='#ExtensibleInformation'>Extensible Information</A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='AVP' or $category='Fixed' or $category='Delimited' or $category='LDIF' or $category='DSML'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#Partition' > Partitions Configured </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='ADAM'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#ADAM1' > ADAM Server Connection Information </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#ADAM2' > Directory Partitions Configured </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='iPlanet'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#iPlanet1' > Logon Information  </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#iPlanet2' > Naming Context Configuration </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='IBM DS'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#IBMDS1' > Logon Information  </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#IBMDS2' > Naming Context Configuration </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='Exchange' or $category='Exchange GAL'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#Exchange1' > Organization Connection Information </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#Exchange2' > Sites Configuration  </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='eDirectory'">
                    <Td class="tdMenu">
                      <b>
                        <A  href='#eDirectory1' > Server Connection Information </A>
                      </b>
                    </Td>
                    <Td class="tdMenu">
                      <b>
                        <A  href='#eDirectory2' > Selected Containers </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='NT'">
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#NT1' > Domain Connection Information </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='AD' or $category='AD GAL'">
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#SelObjects' > Selected Object Types </A>
                      </b>
                    </Td>
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#Attri1' > Selected Attributes </A>
                      </b>
                    </Td>
                  </xsl:if>

                  <xsl:if test="$category='ADAM' or $category='iPlanet' or $category='IBM DS' or $category='Exchange' or $category='Exchange GAL' or $category='eDirectory' or $category='NT' ">
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#SelObjects' > Selected Object Types </A>
                      </b>
                  ...
                  <xsl:if test="$category='Exchange' or $category='Exchange GAL' or $category='NT' or $category='iPlanet' or $category='IBM DS' or $category='eDirectory'">
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#Attri1' > Selected Attributes </A>
                      </b>
                  ...
                  <xsl:if test="$category='Notes'">
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#Notes1' > Server Connection Information  </A>
                      </b>
                    </Td>
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#Notes2' > Organizational Units Configured </A>
                      </b>
                    </Td>
                    <Td  class="tdMenu" >
                      <b>
                    ...
                    <Td  class="tdMenu" >
                      <b>
                        <A  href='#Notes3' > Selected Attributes </A>
                      </b>
                    </Td>
                  </xsl:if>
                  ...
                  <xsl:if test="$category='iPlanet' or $category='IBM DS'">
                    <xsl:if test="//ma-data/private-configuration/ipma-configuration/anchor-attributes/anchor-attribute/.">
                      <Td  class="tdMenu" >
                        <b>
                          <A  href='#SelectedAnchorAttributes' > Selected Anchor Attributes </A>
                        </b>
                      </Td>
                    </xsl:if>
                  </xsl:if>
                  ...
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#connectorfilters' > Connector Filters </A>
                    </b>
                  </Td>
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#Joinandprojection' > Join and Projection Rules </A>
                    </b>
                  </Td>
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#AttributeFlow' > Attribute Flow </A>
                    </b>
                  </Td>
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#Deprovisioning' > Deprovisioning </A>
                    </b>
                  </Td>
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#MAExDLL' > MA Extensions </A>
                    </b>
                  </Td>
                  <Td  class="tdMenu" >
                    <b>
                      <A  href='#RSofMA' > Run Profiles</A>
                    </b>
                  </Td>
                </Tr>
              </TABLE>
          ...
          <TR>
            <TD>
              <h3>
                <xsl:value-of select="//ma-data/name"/> Management Agent
              </h3>
              <hr></hr>
            </TD>
          </TR>
		...
		and $category !='Notes' and $category !='DB2' and $category != 'Extensible' and $category != 'Extensible2'">
                          ...
                          <tr>
                            <xsl:if test="$category">
                              ...
                              <xsl:choose>
                                ...
                                <xsl:when test="$category='Extensible2'">
                                  <td> Extensible Connectivity 2 </td>
                                </xsl:when>
                          ...
                          <tr>
                            ...
                            <xsl:choose>
                              <xsl:when test="//ma-data/description!=''">
                                <td class="tdClass3">
                                  <xsl:value-of disable-output-escaping="yes" select="//ma-data/description"/>
                                </td>
                              </xsl:when>
                              <xsl:otherwise>
                                <td>
...
-->
                          <tr>
                            ...
                            <td>
                              <xsl:value-of select="//ma-data/creation-time"/>
                            </td>
                          </tr>
                          <!--
**********************************************************************************************************************************
...
-->
                          <tr>
                            ...
                            <td>
                              <xsl:value-of select="//ma-data/last-modification-time"/>
                            </td>
                          </tr>
...
-->
                <xsl:if test="$category='AD' or $category = 'AD GAL'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>AD Forest Connection Information </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#AdForest'></a>
                      <table cellspacing='0' cellpadding='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4">
                        <tr >
                          <th colspan='2' class="thAtrributeFlow1">
                            <b>Forest Connection Information</b>
                          </th>
                        </tr>
                        ...
                        <tr >
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/adma-configuration/forest-name!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/adma-configuration/forest-name"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr >
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/adma-configuration/forest-login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/adma-configuration/forest-login-user"/>
                              </td>
                            </xsl:when>
                ...
                <!--
**********************************************************************************************************************************
    This is sub-section of Private Configuration which handles the Private Configuration data of an MA of Type Extensible/Extensible2
**********************************************************************************************************************************
-->
                <xsl:if test="$category='Extensible' or $category='Extensible2'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>Extensible Information </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#ExtensibleInformation'></a>
                      <Table>
                        <tr>
                          <td>
                            <table cellspacing='0' cellpadding='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4">
                              <tr>
                                <th colspan='2' class="thAttributeFlow">
                              ...
                              <tr>
                                <td>Import mode supported:</td>
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/MAConfig/extension-config/import-mode!=''">
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/extension-config/import-mode"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                              ...
                              <tr>
                                ...
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/MAConfig/extension-config/export-mode!=''">
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/extension-config/export-mode"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                              ...
                              <tr>
                                ...
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/MAConfig/extension-config/filename!=''">
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/extension-config/filename"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                              ...
                              <tr>
                                ...
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/MAConfig/extension-config/connection-info/connect-to!=''">
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/extension-config/connection-info/connect-to"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                              ...
                              <tr>
                                ...
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/MAConfig/extension-config/connection-info/user!=''">
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/extension-config/connection-info/user"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                        ...
                        <xsl:if test="$category='Extensible'">
                          <tr>
                            <td>
                              <table cellspacing='0' cellpadding='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4">
                                <tr>
                                  <th colspan='3' class="thAttributeFlow">
...
-->
                <xsl:if test="$category='ADAM'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>
                        ADAM<br></br>Connection Information
                      </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#ADAM1'></a>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/adma-configuration/forest-port!= ''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/adma-configuration/forest-port"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose>
                            <xsl:when test="//ma-data/private-configuration/ipma-configuration/default-server!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/ipma-configuration/default-server"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/ipma-configuration/default-login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/ipma-configuration/default-login-user"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose>
                            <xsl:when test="//ma-data/private-configuration/dsma-configuration/default-server!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/dsma-configuration/default-server"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/dsma-configuration/default-login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/dsma-configuration/default-login-user"/>
                              </td>
                            </xsl:when>
...
-->
                <xsl:if test="$category='Exchange' or $category='Exchange GAL'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>Organization Connection Information </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#Exchange1'></a>
                      <table cellspacing='0' cellpadding='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4" >
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/exma-configuration/default-server!=''">
                              <td >
                                <xsl:value-of select="substring-before($serverinfo,':')"/>
                              </td>
                            </xsl:when>
                            <xsl:otherwise>
                              <td>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/exma-configuration/default-server!=''">
                              <xsl:if test="substring-after($serverinfo,':') != ''">
                                <td >
                                  <xsl:value-of select="substring-after($serverinfo,':')"/>
                                </td>
                              </xsl:if>

                              <xsl:if test="substring-after($serverinfo,':') = ''">
                                <td>
                                  <xsl:text> 389 </xsl:text>
                                </td>
                              </xsl:if>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/exma-configuration/default-login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/exma-configuration/default-login-user"/>
                              </td>
                            </xsl:when>
                            <xsl:otherwise>
                              <td>
...
-->
                <xsl:if test="$category='eDirectory'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>Server Connection Information </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#eDirectory1'></a>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/edma-configuration/default-server!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/edma-configuration/default-server"/>
                              </td>
                            </xsl:when>
                            <xsl:otherwise>
                              <xsl:text> None </xsl:text>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/edma-configuration/default-login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/edma-configuration/default-login-user"/>
                              </td>
                            </xsl:when>
                            <xsl:otherwise>
                              <td>
                  ...
                  <TR>
                    ...
                    <TD align='left'>
                      ...
                      <table cellspacing='0' cellpadding='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4">
                        <tr>
                          <th colspan='2' class="thAttributeFlow1">
                            <b> Connect to Notes server Information </b>
                          </th>
                        </tr>

                        <tr>
                          <td >
                            <b> Hierarchical Server name:</b>
                          </td>
                          <td >
                            <xsl:value-of select="//ma-data/private-configuration/lnma-configuration/server"/>
                          </td>
                        </tr>
...
-->
                <xsl:if test="$category='NT'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>Domain Connection Information </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#NT1'></a>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/ntma-configuration/domain!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/ntma-configuration/domain"/>
                              </td>
                            </xsl:when>
                        ...
                        <tr>
                          ...
                          <xsl:choose >
                            <xsl:when test="//ma-data/private-configuration/ntma-configuration/login-user!=''">
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/ntma-configuration/login-user"/>
                              </td>
                            </xsl:when>
                      ...
                      <table border='1' cellpadding='0' cellspacing='0' bordercolordark='#ffffff'>
                        ...
                        <xsl:if test="//ma-data/private-configuration/oledbma-configuration/connection-info/server">
                          <tr>
                            ...
                            <td >
                              <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/connection-info/server"/>
                            </td>
                          </tr>
                        </xsl:if>
                        ...
                        <tr>
                          <xsl:choose>
                            <xsl:when test="//ma-data/private-configuration/oledbma-configuration/connection-info/databasename">
                              ...
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/connection-info/databasename"/>
                              </td>
                            </xsl:when>
                            ...
                            <xsl:when test="//ma-data/private-configuration/oledbma-configuration/connection-info/datasource">
                              ...
                              <td >
                                <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/connection-info/datasource"/>
                              </td>
                            </xsl:when>
                              ...
                              <xsl:for-each select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/attributes/attribute">
                                <tr>
                                  ...
                                  <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                      <td>
                                        <xsl:value-of select="@ lower_bound"/>
                                      </td>
                                    </xsl:otherwise>
                                  </xsl:choose>
                                  ...
                                  <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                      <td>
                                        <xsl:value-of select="@ upper_bound"/>
                                      </td>
                                    </xsl:otherwise>
                                  </xsl:choose>
                                </tr>
                          ...
                          <TD>
                            <table  border='1' cellpadding='0' cellspacing='0' bordercolordark='#ffffff' align='left' class="tableClass4">
                              ...
                              <xsl:if test="$category!='LDIF' and $category!='DSML'">
                                <tr>
                                  <td>
                                    <b>Input file contains LDAP distinguished name: </b>
                                  </td>
                                  <td>
                                    <xsl:choose>
                                ...
                                <xsl:if test="//ma-data/private-configuration/MAConfig/ldap-dn='1'">
                                  <tr>
                                    <td>
                                      <b> Distinguished name attribute: </b>
                                    </td>
                                    <xsl:choose>
                                      <xsl:when test="$category='DSML'">
                                        <td> - </td>
                                      ...
                                      <xsl:otherwise>
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/MAConfig/importing/dn/attribute"/>
                                        </td>
                                      </xsl:otherwise>
                                    </xsl:choose>
                                  </tr>
                                ...
                                <xsl:if test="//ma-data/private-configuration/MAConfig/change_type_attribute!=''">
                                  <tr>
                                    <td>
                                      <b>Change type attribute: </b>
                                    </td>
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/change_type_attribute"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                    ...
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/modify_change_type_value"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                    ...
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/add_change_type_value"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                    ...
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/delete_change_type_value"/>
                                    </td>
                                  </tr>
                                </xsl:if>
                                ...
                                <tr>
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="//ma-data/private-configuration/MAConfig/attribute_value_pair_format/code_page!=''">
                                      <td>
                                        <xsl:value-of select="//ma-data/private-configuration/MAConfig/attribute_value_pair_format/code_page"/>
                                ...
                                <tr>
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="//ma-data/private-configuration/MAConfig/ldif_format/code_page!=''">
                                      <td>
                                        <xsl:value-of select="//ma-data/private-configuration/MAConfig/ldif_format/code_page"/>
                                        <xsl:if test="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description/.">
                                          - <xsl:value-of select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description"/>
                                        </xsl:if>
                                      </td>
                                ...
                                <tr>
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="//ma-data/private-configuration/MAConfig/fixed_width_format/code_page!=''">
                                      <td>
                                        <xsl:value-of select="//ma-data/private-configuration/MAConfig/fixed_width_format/code_page"/>
                                        <xsl:if test="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description/.">
                                          - <xsl:value-of select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description"/>
                                        </xsl:if>
                                      </td>
                                ...
                                <tr>
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="//ma-data/private-configuration/MAConfig/delimited_format/code_page!=''">
                                      <td>
                                        <xsl:value-of select="//ma-data/private-configuration/MAConfig/delimited_format/code_page"/>
                                        <xsl:if test="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description/.">
                                          - <xsl:value-of select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description"/>
                                        </xsl:if>
                                      </td>
                                ...
                                <tr>
                                  ...
                                  <xsl:choose>
                                    <xsl:when test="//ma-data/private-configuration/MAConfig/dsml_format/code_page!=''">
                                      <td>
                                        <xsl:value-of select="//ma-data/private-configuration/MAConfig/dsml_format/code_page"/>
                                        <xsl:if test="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description/.">
                                          - <xsl:value-of select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/properties/code_page_description"/>
                                        </xsl:if>
                                      </td>
                              ...
                              <xsl:if test="//ma-data/private-configuration/MAConfig/importing/object_class_attribute/.!='' or //ma-data/private-configuration/MAConfig/importing/default_object_class/.!=''">
                                <tr>
                                  <td colspan='2'>
                                    <b> Define Object Class:</b>
                                  </td>
                                </tr>
                                <xsl:if test="//ma-data/private-configuration/MAConfig/importing/object_class_attribute/.">
                                  <tr>
                                    <td>
                                      <b>Object Class Attribute: </b>
                                    </td>
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/importing/object_class_attribute"/>
                                    </td>
                                  </tr>
                                </xsl:if>
                                <xsl:if test="//ma-data/private-configuration/MAConfig/importing/default_object_class/.">
                                  <tr>
                                    <td>
                                      <b>Fixed Object Type Value: </b>
                                    </td>
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/MAConfig/importing/default_object_class"/>
                                    </td>
                                  </tr>
                                </xsl:if>
                              </xsl:if>
                    ...
                    <TD align='left'>
                      ...
                      <table border='1' bordercolordark='#ffffff' cellpadding='0' cellspacing='0' align='left' class="tableClass4">
                        ...
                        <xsl:for-each select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/primary_class_mappings/mapping">
                          <tr>
                            <td>
                              <xsl:value-of select="@object_class"/>
                            </td>
                            <td>
                              <xsl:value-of select="@primary_class"/>
                            </td>
                          </tr>
                        </xsl:for-each>
                      </table>
...
-->
                <xsl:if test="$category='Fixed' or $category='DSML' or $category='AVP' or $category='Delimited' or $category='LDIF' or $category='Extensible' ">
                  <TR>
                    <TD class="tdLeftSection">
                      <b> Define Object Types </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#DefineObjectTypes'></a>
                      <table align='left' class="tableClass4">
                        <xsl:for-each select="//ma-data/private-configuration/MAConfig/ui-data/xmlwizard/object_classes/object_class">
                          <xsl:if test="@selected!=0">
                            ...
                            <tr>
                              <td>
                                <b>Use distinguished name as anchor attribute: </b>
                              </td>
                              <td>
                                <xsl:choose>
                                  ...
                                  <tr>
                                    <td>
                                      <table class="tableClass4" id='1' border='1' cellspacing='0' bordercolordark='#ffffff'>
                                        <tr>
                                          <td>
                                            <b>Preferred Domain Controllers: </b>
                                          </td>
                                          <xsl:choose>
                                        ...
                                        <tr>
                                          <td>
                                            <b>Last domain controller used: </b>
                                          </td>
                                          <xsl:choose>
                                            <xsl:when test="custom-data/adma-partition-data/last-dc">
                                              <td>
                                                <xsl:value-of select="custom-data/adma-partition-data/last-dc"/>
                                              </td>
                                            </xsl:when>
                                        ...
                                        <tr>
                                          <td>
                                            <b>Only use preferred domain controller: </b>
                                          </td>
                                          <xsl:choose>
                                        ...
                                        <tr>
                                          <td>
                                            <b>Sign and encrypt LDAP traffic:</b>
                                          </td>
                                          <xsl:choose>
                                            ...
                                            <tr>
                                              ...
                                              <xsl:choose>
                                                <xsl:when test="custom-data/adma-partition-data/login-user">
                                                  <td>
                                                    <xsl:value-of select="custom-data/adma-partition-data/login-user"/>
                                                  </td>
                                                </xsl:when>
                                    ...
                                    <tr>
                                      <td>
                                        <table cellspacing='0' cellpadding='0' border='1' width='100%' bordercolordark='#ffffff'>
                                          <tr>
                                            <td colspan='2'>
                                              <b> Selected Containers to Synchronize </b>
                                            </td>
                                          </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <xsl:choose>
                                              ...
                                              <xsl:otherwise>
                                                <xsl:value-of select="password-sync/max-changes-allowed"/>
                                              </xsl:otherwise>
                                            </xsl:choose>
                                          </td>
                                        </tr>
...
-->
                <xsl:if test = "$category = 'ADAM'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b>Directory Partitions Configured</b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#ADAM2'></a>
                      <table align='left' class="tableClass4">
                                      ...
                                      <tr>
                                        <td>
                                          <table border='1' cellspacing='0' cellpadding='0' bordercolordark='#ffffff' align='left' class="tableClass4">
                                            ...
                                            <tr>
                                              <td>
                                                <b>Only use preferred servers</b>
                                              </td>
...
-->
                <xsl:if test="$category='iPlanet'">
                  <TR>
                    <TD class="tdLeftSection">
                      <b> Naming Context Configuration </b>
                    </TD>
                    <TD align='left'>
                      <a NAME='#iPlanet2'></a>
                          ...
                          <xsl:when test="//ma-data/private-configuration/ipma-configuration/anti-trawling/trawling-filter!=''">
                            ...
                            <xsl:for-each select="//ma-data/private-configuration/ipma-configuration/anti-trawling/trawling-filter">
                              <tr>
                                <td>
                                  <u>
                                    For Attribute '<xsl:value-of select="@attribute"/>' values are
                                  </u>
                                </td>
                              </tr>
...
-->
                <xsl:if test="$category='Notes'">
                  <TR>
                    <td class="tdLeftSection">
                      <b>Organizational Units Configured</b>
                    </td>
                    <td align='left'>
                      <a NAME='#NOTES2'></a>
                      <table >
                          ...
                          <td>
                            <table cellpadding='0' cellspacing='0' border='1' bordercolordark='#ffffff' >
                              ...
                              <xsl:for-each select="//ma-data/private-configuration/lnma-configuration/ou-list/item">
                                <tr>
                                  <td>
                                    <xsl:value-of select="nab"/>
                                  </td>
                                  <td>
                                    <xsl:value-of select="ou"/>
                                  </td>
                                  <td>
                                    <xsl:value-of select="certifier-path"/>
                                  </td>
                                </tr>
                              </xsl:for-each>
                            </table>
...
-->
                  ...
                  <TR>
                    ...
                    <TD align='left'>
                      ...
                      <table cellpadding='0' cellspacing='0' border='1' bordercolordark="#ffffff" align='left' class="tableClass4">
                        <tr>
                          <td colspan='2'>
                            <b>GAL Container Configuration </b>
                          </td>
                        </tr>

                        <tr>
                          <td>
                            <b>Destination container for contacts synchronized with this forest:</b>
                          </td>
                          <td>
                            <xsl:value-of select="//ma-data/private-configuration/adma-configuration/ui-data/galma/target-ou"/>
                          </td>
                        </tr>

                        <tr>
                          <td>
                            <b>Source containers with authoritative contacts in the forest:</b>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <b>SMTP mail suffix(s)for mailbox and mail objects in this forest:</b>
                          </td>
                          <td>
                            <table class="tableClass5" >
                        ...
                        <tr>
                          <td >
                            <b>Contact object type associated with this forest</b>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <b>Administrator Group for Exchange interoperability with Exchange 5.5 and Active Directory Connector environments</b>
                          </td>
                          <td>
                            <xsl:choose>
    ...
    #################################################################################################################################
-->
                <xsl:if test="$category='AD' or $category='AD GAL' or $category='ADAM' or $category='Notes' or $category='iPlanet' or $category='IBM DS' or $category='Exchange' or $category='Exchange GAL' or $category='eDirectory' or $category='NT' ">
                  <TR>
                    <td class="tdLeftSection">
                      <b>Selected Object Types  </b>
                    </td>
                    <td align='left' class="tdClass5">
                      <a NAME='#SelObjects'></a>
...
-->
                          ...
                          <td>
                            <table  cellpadding='0' cellspacing='0' border='1' bordercolordark="#ffffff" align='left' class="tableClass4">
                              ...
                              <tr>
                                ...
                                <td>
                                  <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/object-type"/>
                                </td>
                              </tr>
                                  ...
                                  <td colspan='2'>
                                    <table cellpadding='0' cellspacing='0' border='1' bordercolordark="#ffffff" align='center' class="tableClass4">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/delta-info/update"/>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/delta-info/add"/>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/delta-info/delete"/>
                                        </td>
                                      </tr>

                                      <tr>
                                        <td>
                                          <b> Attribute modify:</b>
                                        </td>
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/delta-info/update-attribute"/>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <b> Attribute Level Synchronization Column:</b>
                                        </td>
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/delta-info/attribute-column"/>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                                ...
                                <tr>
                                  <td colspan='2'>
                                    <table cellpadding='0' cellspacing='0' border='1' bordercolordark="#ffffff" align='center' class="tableClass4">
                                      <tr>
                                        <td>
                                          <b> Attribute name column:</b>
                                        </td>
                                        <td>
                                          <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/multivalued-info/attribute-column"/>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <b> String attribute column: </b>
                                        </td>
                                        <td>
                                          <xsl:choose>
                                      ...
                                      <tr>
                                        <td>
                                          <b> Large String attribute column: </b>
                                        </td>
                                        <td>
                                          <xsl:choose>
                                      ...
                                      <tr>
                                        <td>
                                          <b> Large Binary attribute column: </b>
                                        </td>
                                        <td>
                                          <xsl:choose>
                              ...
                              <tr>
                                <xsl:choose>
                                  <xsl:when test="//ma-data/private-configuration/oledbma-configuration/mms-info/object-type-info/object-type-column!=''">
                                    <td>Column:</td>
                                    <td>
                                      <xsl:value-of select="//ma-data/private-configuration/oledbma-configuration/mms-info/object-type-info/object-type-column"/>
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>Fixed</td>
                ...
                <!--
    #################################################################################################################################
    This section handles the Selected Objects for Extensible and Extensible2
    #################################################################################################################################
-->
                <xsl:if test="$category='Extensible' or $category='Extensible2'">
                  <TR>
                    <TD align='left' class="tdLeftSection">
                      <b>Selected Object Types </b>
                    </TD>

                    <xsl:choose>

                      <xsl:when test="//ma-data/schema/dsml:dsml/dsml:directory-schema/dsml:class">
                        ...
                        <td class="tdClass2">
                          ...
                          <xsl:for-each select="//ma-data/schema/dsml:dsml/dsml:directory-schema/dsml:class">
                            <li>
                      ...
                      <xsl:otherwise>
                        <td>
                          <xsl:text>No objects selected</xsl:text>
                        </td>
                      </xsl:otherwise>
                    </xsl:choose>
                  </TR>
    ...
    *** Now also supports Extensible and Extensible2 ***
    #################################################################################################################################
-->
                <xsl:if test="$category='AD' or $category='AD GAL' or $category='ADAM'or $category='Exchange' or $category='Exchange GAL' or $category='NT' or $category='iPlanet' or $category='IBM DS' or $category='eDirectory' or $category='Extensible' or $category='Extensible2'">
                  <TR>
                    <TD align='left' class="tdLeftSection">
                      <b>Selected Attributes </b>
                    </TD>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <td>
                          <xsl:text>No attributes selected</xsl:text>
                        </td>
                      </xsl:otherwise>
                    </xsl:choose>
                  </TR>
...
-->
                ...
                <xsl:if test="$category='iPlanet' or $category='IBM DS'">
                  <xsl:if test="//ma-data/private-configuration/ipma-configuration/anchor-attributes/anchor-attribute/.">
                    <TR>
                      <TD class="tdLeftSection">
                        <b> Selected Anchor Attributes </b>
                      </TD>
                      <TD align='left'>
                        <a NAME='#SelectedAnchorAttributes'></a>
                        <Table cellpadding='0' cellspacing='0' border='1' bordercolordark="#ffffff" width='100%' align='left' class="tableClass4">
...
-->
                ...
                <TR>
                  <TD class="tdLeftSection">
                    <b> Connector Filters </b>
                  </TD>
                  <TD align='left'>
                    <a NAME='#connectorfilters'></a>
                    <xsl:choose>
...
-->
                ...
                <TR>
                  <TD class="tdLeftSection">
                    <b>Join and Projection Rules </b>
                  </TD>
                  <TD align='left'>
                    <a NAME='#Joinandprojection'></a>
                    <br></br>
                    <TABLE align='left' class="tableClass4">
                      <TR>
                        <TD>
                                      ...
                                      <xsl:for-each select="//ma-data/join/join-profile">
                                        ...
                                        <xsl:for-each select="join-criterion">
                                          ...
                                          <tr>
                                            <td class="tdClass3">
                                              <b>
                                                <xsl:value-of select="$cdobjecttype"/>
                                              </b>
                                            </td>
                                          ...
                                          <xsl:for-each select="search/attribute-mapping">
                                            <tr>
                                              ...
                                              <xsl:if test="scripted-mapping">
                                                ...
                                                <td class="tdClass3">
                                                  Rules Extension - <xsl:value-of select="scripted-mapping/script-context"/>
                                                </td>
                                                <td class="tdClass3">
                                                  <xsl:value-of select="@mv-attribute"/>
                                                </td>
                      ...
                      <TR>
                        <TD>
                          <TABLE cellspacing='0' cellpadding='0' border='1' bordercolorlight='#ffffff' bordercolordark='#ffffff' width='100%' align='left' class="tableClass4">
                            <TR>
                              <TH class="thAttributeFlow" colspan='4'>
                                <b>Export Attribute Flow </b>
                              </TH>
                            </TR>
                            <TR>
                              <TD>
                                        ...
                                        <xsl:for-each select="export-flow">
                                          <tr>
                                            ...
                                            <xsl:if test="constant-mapping">
                                              ...
                                              <td class="tdClass3">
                                                Constant -  <xsl:value-of select="constant-mapping/constant-value"/>
                                              </td>
                                              <td>
                                                <xsl:choose>
                                                  <xsl:when test="@suppress-deletions!='true'">
                                          ...
                                          <xsl:for-each select="import-flow">
                                            <xsl:if test="@src-ma =$id ">
                                              ...
                                              <tr>
                                                ...
                                                <!-- if the mapping type is sync-rule-mapping (FIM declarative) then go to the following section.-->
                                                <xsl:if test='sync-rule-mapping'>
                                                  <td class="tdClass3">
                                                    <xsl:choose>
                                                      <xsl:when test="sync-rule-mapping/sync-rule-value[import-flow/dest]">
                                                        <xsl:apply-templates select="sync-rule-mapping/sync-rule-value/import-flow/fn" mode="declarative"/>
                                                      </xsl:when>
                                                      <xsl:when test="sync-rule-mapping/sync-rule-value[not(import-flow/dest)]">
                                                        [<xsl:value-of select="sync-rule-mapping/sync-rule-value/text()"/>]
                                                      </xsl:when>
                                                      <xsl:otherwise>
                                                  ...
                                                  <xsl:choose>
                                                    <xsl:when test="sync-rule-mapping/sync-rule-value[import-flow/dest]">
                                                      <td class="tdClass3">SR Expression </td>
                                                    </xsl:when>
                                                    <xsl:when test="sync-rule-mapping/sync-rule-value[not(import-flow/dest)]">
                                                      <td class="tdClass3">SR Direct (Constant) </td>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                      <td class="tdClass3">SR Direct </td>
                                                    </xsl:otherwise>
                                                  </xsl:choose>
                                                </xsl:if>
                                                ...
                                                <xsl:if test="dn-part-mapping">
                                                  ...
                                                  <td class="tdClass3">
                                                    DN Component -  <xsl:value-of select="dn-part-mapping/dn-part"/>
                                                  </td>
                                                </xsl:if>
                                                <td class="tdClass3">
                ...
                <TR>
                  ...
                  <TD align='left'>
                    ...
                    <table cellpadding='0' cellspacing='0' bordercolordark='#ffffff' align='left' border='1' class="tableClass4">
                      ...
                      <tr>
                        <td >
                          <b> Do not recall attributes contributed by an object from this MA when it is disconnected:</b>
                        </td>
                ...
                <TR>
                  ...
                  <TD align='left'>
                    ...
                    <table cellpadding='0' cellspacing='0' bordercolordark='#ffffff' border='1' align='left' class="tableClass4">
                      ...
                      <tr>
                        <td width="50%">
                          <b> Enable Password Management:</b>
                        </td>
                        <td width="50%">
                          <xsl:choose>
                      ...
                      <xsl:if test="//ma-data/ma-partition-data/partition/.">
                        <tr>
                          <th class="thAttributeFlow" colspan='2'>Partitions</th>
                        </tr>
                        <tr>
                          <th class="thAttributeFlow1">
                            <b>Partition Name </b>
...
-->
                    ...
                    <xsl:when test="//ma-data/ma-run-data!=''">
                      <td class="tdClass2" align='left'>
                        ...
                        <xsl:for-each select="//ma-data/ma-run-data/run-configuration">
                          <table cellspacing='0' cellpadding='0' border='1' width='100%' bordercolordark='#ffffff'>
                            <tr>
                              <th class="thAttributeFlow" colspan='2' align='left' >
                                <xsl:value-of select="name"/>
                              </th>
                            </tr>
                            <xsl:for-each select="configuration/step">
                              ...
                              <tr>
                                ...
                                <xsl:choose>
                                  <xsl:when test="dropfile-name!=''">
                                    <td>
                                      <xsl:value-of select="dropfile-name" />
                                    </td>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <td>
                              ...
                              <xsl:if test="threshold!=''">
                                <tr>
                                  ...
                                  <td>
                                    <xsl:value-of select="threshold/object" />
                                  </td>
                                </tr>
                              </xsl:if>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/run-config/input-file!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/run-config/input-file" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/run-config/output-file!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/run-config/output-file" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/adma-step-data/batch-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/adma-step-data/batch-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/adma-step-data/page-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/adma-step-data/page-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/adma-step-data/time-limit!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/adma-step-data/time-limit" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/edma-step-data/batch-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/edma-step-data/batch-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/edma-step-data/page-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/edma-step-data/page-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/edma-step-data/time-limit!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/edma-step-data/time-limit" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/ipma-step-data/batch-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/ipma-step-data/batch-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/ipma-step-data/page-size!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/ipma-step-data/page-size" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
                                  ...
                                  <tr>
                                    ...
                                    <xsl:choose>
                                      <xsl:when test="custom-data/ipma-step-data/time-limit!=''">
                                        <td>
                                          <xsl:value-of select="custom-data/ipma-step-data/time-limit" />
                                        </td>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <td>None</td>
  ...
  <xsl:template match="fn" mode="declarative">
    <xsl:value-of select="@id"/>
    <xsl:text>(</xsl:text>
    <xsl:apply-templates select="arg" mode="declarative" />
    <xsl:text>)</xsl:text>
  </xsl:template>
  <xsl:template match="arg" mode="declarative">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="fn" mode="declarative"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:value-of select="@id"/>

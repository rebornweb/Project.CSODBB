#-------------------------------------------------------------------------------
# Get-SAS2IDMDuplicateUSINs.ps1
#
# Exception report to identify duplicate USINs within the SAME SCHOOL
#
...
param(
    ...
    [string]$logfile = "D:\Logs\Get-SAS2IDMDuplicateUSINs.log",
...
if ($help) {
    @"
NAME
    Get-SAS2IDMDuplicateUSINs

SYNOPSIS
    Exception report to identify duplicate USINs within the SAME SCHOOL.
    
SYNTAX:
    Get-SAS2IDMDuplicateUSINs [[-sasServer] <string>] [[-logfile] <string>] [[-outputfile] <string>] [-help] [-debug]
...
PARAMETERS:
    ...
    -logfile <string>
        The log file for the last execution record this script. The default value is "D:\Logs\Get-SAS2IDMDuplicateUSINs.log".

    -cssfile <string>
        The CSS file required by the script for formatting HTML notifications. The default value is "D:\Scripts\Report.css".

    -outputfile <string>
        The CSV file generated by the script. The default value is "D:\Logs\SAS2IDMDuplicateUSINs.csv".
...
$sql = @"
exec [dbo].[procSAS2IDM_GetDuplicateUSINs]
"@

...
$pilot_filename = "E:\Scripts\Output\pilot_policy.xml"
$production_filename = "E:\Scripts\Output\production_policy.xml"
$changes_filename = "E:\Scripts\Output\changes.xml"
$joinrules = @{

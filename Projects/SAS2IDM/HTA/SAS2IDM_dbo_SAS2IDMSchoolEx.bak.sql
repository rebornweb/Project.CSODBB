...
SELECT     TOP (100) PERCENT dbo.SAS2IDMStudent.SchoolID, dbo.SAS2IDMStudent.StudentID, dbo.SAS2IDMStudent.Code, RTRIM(dbo.SAS2IDMStudent.FirstName) AS [FirstName], 
					  ...
					  CASE WHEN dbo.SAS2IDMSchoolEx.IsPromoted = 1 THEN 'A' ELSE dbo.SAS2IDMStudent.AlumniType END AS [AlumniType],
...
FROM         dbo.SAS2IDMStudent INNER JOIN
                      ...
                      dbo.SAS2IDMStudentEx ON dbo.SAS2IDMStudentEx.SchoolID = dbo.SAS2IDMStudent.SchoolID AND dbo.SAS2IDMStudentEx.StudentID = dbo.SAS2IDMStudent.StudentID LEFT JOIN
					  dbo.SAS2IDMSchoolEx ON dbo.SAS2IDMSchoolEx.SchoolID = dbo.SAS2IDMSchool.SchoolID

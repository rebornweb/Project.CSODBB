...
$pilot_filename = "C:\Unify Solutions\FIM Scripts\pilot_policy.xml"
$production_filename = "C:\Unify Solutions\FIM Scripts\production_policy.xml"
$changes_filename = "C:\Unify Solutions\FIM Scripts\changes.xml"
$joinrules = @{
